"""Tests for the markdown_utils module."""
...
from wwdcdigest.markdown_utils import create_markdown
from wwdcdigest.models import WWDCDigest, WWDCFrameSegment


@pytest.mark.anyio
async def test_create_markdown():
    """Test creating a markdown file from a digest."""
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Create markdown
        result_path = create_markdown(digest, output_path)
